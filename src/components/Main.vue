    ...
    switch (layout.value) {
      case "shop":
        if (xcanvasS.handle) {
          ...
          thaiqrpay_logo.src = '/promptpay-qrcode-maker/Thai_QR_Payment_Logo-01.png';
          ...
          promptpay_logo.src = '/promptpay-qrcode-maker/PromptPay2.png';
          ...
          qrcode_image.onload = function () {
            if (xcanvasS.handle) {
              ...
              thaiqrpay_mini_logo.src = '/promptpay-qrcode-maker/Thai_QR_Payment_Logo-03.png';
            }
          }
